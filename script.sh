...
apt-get install php7.0-curl php7.0-dev php7.0-gd php7.0-intl \
...
wget https://raw.githubusercontent.com/wodby/drupal-nginx/master/1.10/nginx.conf
wget https://raw.githubusercontent.com/wodby/drupal-nginx/master/1.10/drupal8.conf
